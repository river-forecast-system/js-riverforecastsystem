...
// Where the v3 data lives. There is one endpoint: the root of the v3 tree, which is the bucket
// s3://river-forecast-system-v3 served through the CloudFront CDN. Everything the package reads hangs
// off it — retrospective, forecasts, hydrography, and the FLDPLN flood libraries under flood-maps/ —
// so configuring this one value points every reader and url builder at the same tree.

const DEFAULTENDPOINTS = {
  v3Base: "https://d2bu4ozwm6rcbq.cloudfront.net"
};
